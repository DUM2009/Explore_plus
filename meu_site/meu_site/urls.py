...
urlpatterns = [
    ...
    path('exames/<str:exame_id>/', views.pagina_exame_detalhe, name='exame-detalhe'),
    path('api/exames/<str:exame_id>/corrigir/', views.corrigir_exame, name='corrigir-exame'),
    ...
    path('superexplore/gerir/', views.gerir_subscricao, name='gerir-subscricao'),
